...
<head>
	...
	.tainan{
		color:black;font-size:20px;position:absolute;left:800px;top:120px;cursor:pointer;font-weight:bold;
	}
	.kaohsiung{
...
<body style="margin:0px;background-color:#FFFAFA">
	...
	<div style="position:absolute;left:10px;top:150px"><img src="tainan1.jpg" width="300" height="385"></img></div>
	<div style="position:absolute;left:310px;top:150px"><img src="tainan2.jpg" width="300" height="385"></img></div>

<p>
<?php
$link=mysqli_connect("localhost","88user","8811") or die ("無法開啟Mysql資料庫連結"); //建立mysql資料庫連結
mysqli_select_db($link, "data"); //選擇資料庫data
$sql = "SELECT * FROM tainan"; //在data資料表中選擇所有欄位
