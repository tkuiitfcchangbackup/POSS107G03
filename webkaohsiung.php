...
<head>
	...
	.kaohsiung{
		color:black;font-size:20px;position:absolute;left:900px;top:120px;cursor:pointer;font-weight:bold;
	}
	.aboutus{
...
<body style="margin:0px;background-color:#FFFAFA">
	...
	<div style="position:absolute;left:10px;top:150px"><img src="kaohsiung1.jpg" width="300" height="385"></img></div>
	<div style="position:absolute;left:310px;top:150px"><img src="kaohsiung2.jpg" width="300" height="385"></img></div>
...
$sql = "SELECT * FROM kaohsiung"; //在data資料表中選擇所有欄位
